...
Artificial intelligence researcher, software engineer, and teacher with research interests centered on AI alignment, mechanistic interpretability, and online learning. Rensselaer Polytechnic Institute graduate with a Master's of Science in Computer Science. Research experience in industry and academic AI labs, published research, and lecture experience. Proven ability to create novel, rigorous research, efficiently design technical software, and lead groups in research and professional software development. Additional experience teaching courses in computer science as both an assistant and an adjunct instructor.
...
\begin{itemize}
    ...
    \item \textbf{Teaching} \textit{(3 years)}: Experience holding lectures, managing curricula, designing assignments, testing and grading.
...
\begin{itemize}
    ...
    \item \textbf{SUNY New Paltz}: \textit{Research Assistant} (2022), New Paltz, NY. Research into chip firing games and programmatically manipulating directed graphs. Mentored by Jaiung Jun.
...
\begin{itemize}
    ...
    \item \textbf{SUNY Ulster}: \textit{Computer Science Adjunct} (2025-Present), Stone Ridge, NY. Instruct \textit{Computer Architecture and Organization} course.  Lecture, manage curriculum, grade student work, attend faculty meetings, and coordinate with colleagues.
    
    \item \textbf{Rensselaer Polytechnic Institute}: \textit{Graduate Teaching Assistant} (2023-2024), Troy, NY. Provide students with assistance, grade assignments for the \textit{Principles of Software} and \textit{Data Structures} classes.
...
\begin{itemize}
    ...
    \item \textbf{Transformer Models: Architectures and Use Cases}: A technical lecture on the transformer architecture and attention mechanism. Given as a part of IBM's internal technical lecture series.
    ...
    \item \textbf{Homophone Decoding and Speech Based Emotion Detection}: Presentation for the study, commissioned as a part of an RPI-IBM collaboration, focused on developing an automatic speech recognition (ASR) model with better accuracy on homophones. Presented to principal investigators and IBM grantors.
...
\begin{itemize}
    ...
    \item \textbf{Marist Computing Conference}: Serve as a judge of student poster presentations on research projects and nominated projects for conference awards.
...
\begin{itemize}
    ...
    \item \textbf{Manifest Destiny}: Massively parallel population simulation written in C and CUDA. Designed to run across multiple GPUs and nodes using MPI and CUDA. Developed for RPI's class on parallel computing along with research report. \href{https://matthewpisano.com/school/destiny}{\textit{matthewpisano.com/school/destiny}}.
    ...
    \item \textbf{Chip Firing Simulation}: A detailed chip firing game simulator designed to record game behavior and extract patterns from graph node and direction permutations. \href{https://matthewpisano.com/research/chipFiring}{\textit{matthewpisano.com/research/chipFiring}}.
...
\begin{itemize}
    ...
    \item \textbf{Engineers Week}: Annual event sponsored by IBM where engineers visit primary and secondary schools to speak with students and educate them on the field of engineering and how to become future engineers. Visits involve lectures and hands-on activities with students.
