...
\begin{itemize}
    ...
    \item \textbf{Research} \textit{(3 years)}: Peer-reviewed publications, academic talk invitations, work in indistry/academic research labs.
    \item \textbf{Teaching} \textit{(3 years)}: Experience holding lectures, managing curricula, designing assignments, testing/grading.
...
\begin{itemize}
    ...
    \item \textbf{SUNY Ulster}: \textit{Computer Science Adjunct} (2025-Present), Stone Ridge, NY. Instruct \textit{Architecture and Organization} course.  Lecture, manage curriculum, grade student work, attend faculty meetings, and coordinate with colleagues.
