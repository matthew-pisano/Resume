...
\begin{itemize}
    ...
    \item \textbf{SUNY Ulster} (\textit{Computer Science Adjunct, 2025}), Stone Ridge, NY. Instruct \textit{Architecture and Organization} course.  Lecture, manage curriculum, assign and grade student work; attend regular faculty meetings and coordinate with colleagues.
